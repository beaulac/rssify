...
exports.checkHeader = (feedConfig, cb) => {
    ...
    determineAgent(options).request(options, function (res) {
...
exports.update = (feedConfig, cb) => {
    exports.checkHeader(feedConfig, same => {
        ...
        determineAgent(feedConfig.url).get(feedConfig.url, res => {
            var data = '';
            res.on('data', chunk => {
                data += chunk;
            });
...
exports.process = feedName => {
    ...
    exports.update(feedConfig, (err, entry) => {
        ...
        exports.debug && console.log('Received updated entry from ' + feedName + ' ('+ feedConfig.url + ')');
